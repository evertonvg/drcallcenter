...
// Configurações para utilização do SMTP do Gmail
    ...
    $mail->Host = "drcallcenter.com.br";

    $mail->Port = 465; // Porta de envio de e-mails do Gmail 587 e hostgator 465
...
// Remetente da mensagem
    ...
    $mail->SetFrom("contato@drcallcenter.com.br");

// Endereço de destino do email
    $mail->AddAddress('contato@drcallcenter.com.br'); 
